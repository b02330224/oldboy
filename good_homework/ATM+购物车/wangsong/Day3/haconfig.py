...
class haproxy(object):
    ...
    _default_path = os.path.dirname(os.path.basename("__file__"))
    _default_file = os.path.join(_default_path, "haproxy.cfg")
    _tmp_file = os.path.join(_default_path, "tmp.cfg")
